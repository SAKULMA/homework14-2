...
import 'package:homework14/api/api.dart';
    ...
    return Scaffold(
      ...
      body: Container(
        child: Column(
          ...
          children: [
            Text('อายุอาจารย์',style: GoogleFonts.lato(fontSize: 40.0),),
            Padding(
                  ...
                  children: [
                    Padding(
                      child: SpinBox(
                        ...
                        max: 150,
                        value: 1,
                        decoration: InputDecoration(labelText: 'ปี',labelStyle: GoogleFonts.lato(fontSize: 40.0)),
                        onChanged: (year){
                          setState(() {
                            print(year);
                            y = year as int;
                    ...
                    Padding(
                      child: SpinBox(
                          ...
                          value: 1,
                          readOnly: true,
                          decoration: InputDecoration(labelText: 'เดือน',labelStyle: GoogleFonts.lato(fontSize: 40.0)),
                          onChanged: (month){
                            setState(() {
                              print(month);
                              m = month as int;
                    ...
                    Padding(
                      ...
                      child: ElevatedButton(
                        ...
                        child:  Text('ทาย',style: GoogleFonts.lato(fontSize: 20),),
                      ),
                    ),
                  ],
                ),
